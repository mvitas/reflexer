...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//
		// RXDatabaseHelper helper = new RXDatabaseHelper(this, "reflexer",
		// null,
		// 1);
		...
		// // }
		// //
		// // //TODO umjesto last_insert_rowid() dohvatiti id bas rx_reactiona
		// jer
		...
		// }
		//
		// ArrayList<RXStimuliCondition> stimuliConditionList = new
		// ArrayList<RXStimuliCondition>();
		//
		...
		// RXTypeCaster.getInstance().initializeType(type1Rea,
		// "[\"penisici i pice\"]"));
		// p2 = new RXReactionProperty("text",
		// RXTypeCaster.getInstance().initializeType(type2Rea,
		// "[\"tesits text to testis\"]"));
	...
	private final ServiceConnection mConnection = new ServiceConnection() {
		...
		public void onServiceConnected(ComponentName className, IBinder binder) {
			...
			RXStimuli callStim = new RXStimuli(MainActivity.this, "PhoneCallStimuli");
			callStim.setCondition(new RXStimuliCondition("incoming", Boolean.FALSE));

			RXReaction callRe = RXReaction.createReaction(MainActivity.this, "TestReaction");

			RXReflex callRef = new RXReflex("call me mybe", callStim, callRe);

			serviceBinder.addReflex(reflex);
			serviceBinder.addReflex(batRef);
			serviceBinder.addReflex(pwRef);
			serviceBinder.addReflex(callRef);
