...
public class RXMapper {
	...
	private static RXStimuli getStimuli(Cursor c) {
		int id = (Integer.valueOf(c.getString(indexOfCOLUMN_RX_STIUMLI_ID)));
		String name = (c.getString(indexOfCOLUMN_SIMULUS_ACTION_NAME));

		// TODO treba mu context
		// return new RXStimuli(context, id, name);
